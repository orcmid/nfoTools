<!-- T060101b.md 0.1.0              UTF-8                          2021-11-16
     ----1----|----2----|----3----|----4----|----5----|----6----|----7----|--*
...
development of familiarity with C/C++ Programming.  This is also an useful
foundation for anyone who wants to become more involved with nfoWare projects
and many open-source projects targeted to Microsoft Windows environments.
