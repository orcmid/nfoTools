...
* https://www-cs-faculty.stanford.edu/~knuth/sgb.html and nfoFlip.h here.
*
*/
...
int main(void)
{
    ...
    if (first != 119318998)
         { fputs("           FAILURE ON THE FIRST TRY!\n\n", stdout);
           exit(-1);
           }
    ...
    if (nfoFlipUniformRand(0x55555555L) != 748103812)
         { fputs("           FAILURE ON THE SECOND TRY!\n\n", stdout);
           exit(-2);
           }

    fputs("           OK, the nfoFlip routines seem to work.\n\n", stdout);
